...
public class AvisoActivity extends AppCompatActivity {
    ...
    WebView mWebView;
    private static final String API_URL = "https://app-cbt33jvn5q-uc.a.run.app/api/document/avisodeprivacidad";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AvisoActivity.GetPdfUrlTask().execute(API_URL);
    }
        ...
        protected void onPostExecute(String pdfUrl) {
            ...
            if (pdfUrl != null) {
                ...
                try {
                    ...
                    Toast.makeText(AvisoActivity.this, "No hay aplicación para abrir PDF", Toast.LENGTH_SHORT).show();
                }
            } else {
                Log.e("PDF_ERROR", "No se pudo obtener la URL del PDF");
                Toast.makeText(AvisoActivity.this, "Error al obtener el documento", Toast.LENGTH_SHORT).show();
            }
        }
    }
}